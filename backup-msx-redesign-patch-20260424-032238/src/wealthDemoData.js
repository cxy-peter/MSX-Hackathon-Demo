export const WEALTH_STARTING_CASH = 25000;
export const WEALTH_MILESTONE_BONUS = 1500;
...
export const GOAL_OPTIONS = [
  {
    id: 'capital',
    label: 'Keep principal steadier',
    description: 'Start with real treasury-style products where the yield source, access rules, and redemption terms are easiest to explain.',
    recommended: ['superstate-ustb', 'franklin-fobxx', 'blackrock-buidl']
  },
  {
    id: 'income',
    label: 'Earn stable yield',
    description: 'Compare treasury, money fund, and private-credit style products by net take-home value instead of headline APY alone.',
    recommended: ['superstate-ustb', 'hashnote-usyc', 'openeden-tbill']
  },
  {
    id: 'buydip',
    label: 'Wait before deploying',
    description: 'Park into redeemable treasury-style sleeves when you want yield now but still want the option to rotate later.',
    recommended: ['ondo-usdy', 'superstate-ustb', 'openeden-tbill']
  },
  {
    id: 'bullish',
    label: 'Position for upside',
    description: 'Focus on products whose return depends on active positioning, credit selection, or manager execution rather than simple cash yield.',
    recommended: ['superstate-uscc', 'apollo-acred', 'msx-quant-fund-2']
  },
  {
    id: 'highYield',
    label: 'Take more risk for more yield',
    description: 'Higher income normally means more credit, basis, liquidity, or settlement complexity. The product page should make that tradeoff visible.',
    recommended: ['superstate-uscc', 'hamilton-scope', 'msx-quant-fund-1']
  }
];
...
export const WEALTH_PRODUCTS = [
  {
    ...
    liveTieIn: 'Official Superstate Short Duration US Government Securities Fund mapped into the MSX tutorial shelf.',
    risk: 'Low',
  ...
  },
  {
    ...
    productType: 'Private credit fund',
    status: 'Real product / official distribution',
    liveTieIn: 'Hamilton Lane SCOPE gives the shelf a real tokenized private-credit benchmark with an official on-demand redemption narrative.',
    risk: 'Medium',
  ...
  },
  {
    ...
    productType: 'Private credit fund',
    status: 'Real product / official distribution',
    liveTieIn: 'Apollo ACRED extends the shelf into branded private-credit RWAs with tokenized distribution rails.',
    risk: 'Medium',
  ...
  {
    id: 'msx-quant-fund-1',
    name: 'MSX Quant Fund #1',
    shortName: 'MSXQ1',
    bucket: 'strategy',
    termType: 'closed',
    goals: ['bullish', 'highYield'],
    productType: 'Closed-end quant fund',
    status: 'Real product / MSX public listing',
    liveTieIn: 'MSX public shop listing shows Quant Fund #1 as a 12-month closed product with a stated 1% to 3% weekly target return band.',
    risk: 'High',
    apyRange: '104.00% target annualized payout / MSX weekly midpoint',
    annualYieldRate: 1.04,
    annualYieldBasis: 'MSX stated weekly target band, simple annualized midpoint',
    annualYieldSource: 'MSX public shop listing for Quant Fund #1 shows a 12-month duration and a target weekly return band of 1% to 3%.',
    ...
    baseAsset: 'Digital subscription into MSX closed-end quant fund shares',
    underlying: 'MSX-managed quantitative trading strategy exposure as described on the public listing.',
    ...
    technicalSummary:
      'MSX Quant Fund #1 is treated here as a real closed-end manager sleeve: the wallet still holds a receipt token, but the economics come from a 12-month quant strategy rather than an always-redeemable cash-management product.',
    humanSummary:
    ...
    fees: {
      management: 'See MSX product terms',
      performance: 'Embedded in manager economics',
      lockup: '12-month closed term / no early redemption'
    },
    shareRights: [
      'Represents closed-end fund ownership for one specific MSX manager sleeve.',
  ...
  },
  {
    ...
    productType: 'Closed-end quant fund',
    status: 'Real product / MSX public listing',
    liveTieIn: 'MSX public shop listing shows Quant Fund #2 as a 12-month closed product with a stated 3% to 5% weekly target return band.',
    risk: 'High',
    apyRange: '208.00% target annualized payout / MSX weekly midpoint',
    annualYieldRate: 2.08,
    annualYieldBasis: 'MSX stated weekly target band, simple annualized midpoint',
    annualYieldSource: 'MSX public shop listing for Quant Fund #2 shows a 12-month duration and a target weekly return band of 3% to 5%.',
    ...
    baseAsset: 'Digital subscription into MSX closed-end quant fund shares',
    underlying: 'MSX-managed higher-volatility quantitative trading strategy exposure as described on the public listing.',
    ...
    technicalSummary:
      'MSX Quant Fund #2 is shown as a real but highly aggressive closed-end quant sleeve. The important teaching point is that the wallet receipt exists, but the receipt does not magically convert a manager target into a guaranteed cash product.',
    humanSummary:
    ...
    shareRights: [
      'Represents closed-end fund ownership for a higher-volatility MSX manager sleeve.',

...
export const MIN_PAPER_TRADE = 500;

export const PAPER_LANE_OPTIONS = [
  { id: 'all', label: 'All products' },
  { id: 'public', label: 'Public markets' },
  { id: 'private', label: 'Private markets / pre-IPO' },
  { id: 'leverage', label: 'Leverage & hedging' },
  { id: 'yield', label: 'Earn & yield' },
  { id: 'strategy', label: 'Strategies' },
  { id: 'ai', label: 'Automation / AI' }
];
...
const CURATED_PAPER_PRODUCT_OVERRIDES = {
  ...
  'preipo-window': {
    ticker: 'SPACEX',
    name: 'SpaceX',
    productType: 'Private markets / pre-IPO',
